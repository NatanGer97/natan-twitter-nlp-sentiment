package com.backend.sentiment.kafka;
...
public class KafkaConfig {
    ...
    public KafkaReceiver kafkaReceiver(){
        ...
        return new DefaultKafkaReceiver(ConsumerFactory.INSTANCE, ReceiverOptions.create(props).subscription(Collections.singleton(KafkaTopicConfig.APP_TOPIC)));
    }
